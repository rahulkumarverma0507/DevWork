...
public class CSVParser {
    ...
    public static void main(String[] arg){
    	...
    	System.out.println((List<Integer>)csvParser.getList());
    }
    ...
    public List<String[]> parseCSV(File csvFile,boolean includedHeader) throws FileNotFoundException{
 	   List<String[]> listString = new ArrayList<String[]>();
 	   FileReader fileReader = new FileReader(csvFile);
 	   CSVReader csvReader = new CSVReader(fileReader);
 	   try {
 		   listString = csvReader.readAll();
 		   if(includedHeader && listString.size() > 0){
 			   listString.remove(0);
 		   }
 		   csvReader.close();
 	   } catch (IOException e) {
    ...
    public int generateCSV(List<String[]> listStringArray,String filePath,boolean includedHeader) throws FileNotFoundException{
 	   int returnFlag = 0;
 	   try {
 		   ...
 		   csvWriter.writeAll(listStringArray);
 		   csvWriter.close();
 	   	} catch (IOException e) {
 		   e.printStackTrace();
 		   returnFlag = -1;
